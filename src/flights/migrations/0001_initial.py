# Generated by Django 2.0.3 on 2018-04-17 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flight_departure', to='flights.Airport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sit_class', models.CharField(max_length=32)),
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=10)),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='flights.Client')),
